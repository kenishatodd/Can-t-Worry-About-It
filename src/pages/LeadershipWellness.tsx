...
const practices = [
  {
    ...
    description:
      "Leadership wellness starts with nervous-system awareness. Short grounding practices between meetings help you reset before reacting.",
  },
  {
    icon: CheckCircle,
...
const LeadershipWellness = () => {
  return (
    <>
      <Seo
        title="Leadership Wellness: A Framework for Sustainable Leadership | CWAI"
        description="Leadership wellness helps high-achieving leaders lead with clarity, capacity, and purpose without burning out. Explore the CWAI approach by Dr. Kenisha Todd."
        path="/leadership-wellness"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Leadership Wellness: A Framework for Sustainable Leadership",
          description:
            "Leadership wellness helps high-achieving leaders lead with clarity, capacity, and purpose without burning out.",
          author: {
            "@type": "Person",
          ...
          <div className="container max-w-3xl mx-auto">
            ...
            <section className="prose prose-lg max-w-none mb-16">
              <p className="text-foreground/90 text-lg md:text-xl leading-relaxed mb-6">
                Leadership wellness is the practice of protecting your emotional, mental, and physical capacity so you can lead with consistency and care. It is not a luxury or a soft skill. It is a strategic discipline.
              </p>
              <p className="text-foreground/90 text-lg md:text-xl leading-relaxed mb-6">
                High-achieving leaders are often praised for how much they carry. But being capable of carrying something does not always mean it belongs to you. Leadership wellness helps you distinguish between what requires your energy and what you can release.
              </p>
              <p className="text-foreground/90 text-lg md:text-xl leading-relaxed">
                At CWAI, leadership wellness is built on one idea:{" "}
            ...
            <section className="mb-16">
              <h2 className="font-serif text-2xl md:text-3xl text-foreground mb-6">
                Signs Your Leadership Wellness Needs Attention
              </h2>
              <p className="text-foreground/90 text-lg md:text-xl leading-relaxed mb-6">
