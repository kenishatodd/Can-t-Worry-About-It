          ...
          {items.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mt-1">Add some self-care essentials</p>
              </div>
            </div>
          ) : (
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0">
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-3 bg-secondary/20 rounded-xl">
                      <div className="w-16 h-16 bg-secondary/40 rounded-lg overflow-hidden flex-shrink-0 flex items-center justify-center">
